...
layout: post
title: "为什么事件驱动服务器这么火"
date: 2012-12-31 23:31
comments: true
categories: ["Overview"]
---
>本文基本上这为两篇文章的翻译和整合 --
  [Scalable networking](http://bulk.fefe.de/scalable-networking.pdf) And
  [Why are event-driven server so great](http://andrewbrobinson.com/2012/01/27/why-are-event-driven-servers-so-great/)
...
操作系统fork操作只是简单的拷贝分页映射。动态链接为共享库和全局偏移表中的ELF（Executable and Linking Format）部分创建太多的分页映射。虽然静态的链接fork会是的性能大幅度提升，但是延时依然不乐观。
 ...
 ![](http://geogeo.github.com/images/blog/12312012/fork_delay.png)
图 1 fork延时
### 进程调度
...
![](http://geogeo.github.com/images/blog/12312012/thread.png)
...
- [nginx][8]：一个基于事件驱动的处理请求架构反向代理服务器。 
- [Cherokee][9]：Twitter使用的开源Web服务器。
- [Tornado][13]：一个Python语言实现的非阻塞式Web服务器框架。Facebook的FriendFeed模块使用此框架完成。
- [Node.js][7]：异步非阻塞Web服务器，运行于Google V8 JavaScript引擎。 
...
![](http://geogeo.github.com/images/blog/12312012/event_driven.png)
图 3 事件驱动模型

![](http://geogeo.github.com/images/blog/12312012/apache.png) 
图 4 传统OPPC模型
...
![](http://geogeo.github.com/images/blog/12312012/memuse.png) 
图4 内存占用
 
![](http://geogeo.github.com/images/blog/12312012/cpuuse.png)
图 5  CPU占用
...
[7]: http://nodejs.org/
[8]: http://wiki.nginx.org/Main
[9]: http://www.cherokee-project.com/
